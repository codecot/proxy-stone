...
import { healthRoutes, healthManagementRoutes } from "./routes/health.js";
// import { requestRoutes } from "./routes/requests.js"; // TODO: Fix interface issues
...
// await app.register(requestRoutes, { prefix: "/api" }); // Add request management routes - TODO: Fix interface issues
...
await app.register(healthManagementRoutes, { prefix: "/api" }); // Add health management routes
await app.register(metricsRoutes, { prefix: "/api" }); // Add metrics routes
